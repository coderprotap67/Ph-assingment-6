                    ...
                    <div className="card w-full bg-base-100 shadow-sm text-left">
                        ...
                        <div className="card-body bg-linear-to-r from-blue-600 to-purple-600 text-white relative rounded-lg">
                            <div className='absolute -top-4 left-1/2 transform -translate-x-1/2'>
                                <p className='text-yellow-500 bg-yellow-100 p-2 rounded-3xl'>Most Popular</p>
                            </div>
                            ...
                            <div className="mt-6">
                                <button className="btn text-purple-300 btn-block rounded-3xl">Start Pro Trial</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="card w-full bg-base-100 shadow-sm text-left">
                        <div className="card-body">
                            ...
                            <ul className="mt-6 flex flex-col gap-2 text-xs">
                                <li>
                                    <svg xmlns="http://www.w3.org/2000/svg" className="size-3 me-2 inline-block text-success" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" /></svg>
                            ...
                            <div className="mt-6">
                                <button className="btn btn-primary btn-block rounded-3xl bg-linear-to-r from-blue-500 to-purple-600 text-white">Contact Sales</button>
                            </div>
                        </div>
                    </div>
                </div>
