...
const HeroSection = () => {
    return (
        <div className='flex justify-between max-md:flex-col-reverse gap-4 w-11/12 mx-auto mt-20 mb-10 items-center'>
            <div>
                <div className="badge mb-5 bg-blue-300 py-5 px-3 rounded-4xl text-purple-700"><img src={dot} alt="Dot" />New: AI-Powered Tools Available</div>
                ...
                <div className='flex max-sm:justify-center'>
                    <button className="btn  text-white rounded-3xl bg-linear-to-r from-blue-600 to-purple-600 py-6 mr-1">Explore Products</button>


                    <button className="btn rounded-3xl text-purple-800 border-2 border-purple-800 py-6"><Play className='text-purple-800' />Watch Demo</button>
                </div>
            </div>
