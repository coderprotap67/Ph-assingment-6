...
const ProductCard = ({ data, setCartData, setTotal }) =>
    ...
    return (
        <div className='border-2 border-gray-200 rounded-lg relative flex
         flex-col transition-transform duration-300 
...

            {
                ...
                <button className='btn w-full mt-5 bg-linear-to-r from-blue-500 to-purple-500 text-white rounded-3xl' onClick={() => handleAddToCart(data)}>Buy Now</button>
            </div>
        </div>
    );
};
