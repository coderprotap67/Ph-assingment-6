    ...
    return (
        <div className="navbar bg-base-100 shadow-sm">
            <div className='w-11/12 mx-auto flex justify-between items-center max-sm:flex-col'>
                <div>
                    <p className='text-3xl font-extrabold bg-linear-to-r from-blue-600 to-purple-700 bg-clip-text text-transparent pb-3 max-sm:text-4xl'>DigiTools</p>
                </div>
                ...
                <div>
                    ...
                    <button className="btn text-white rounded-3xl bg-linear-to-r from-blue-600 to-purple-600">Get Started</button>
                </div>
            </div>
        </div>
    );
